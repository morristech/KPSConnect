...
[ -f app/app-release.apk] && mv app/app-release.apk app/kpsconnect-beta-$(git rev-parse --short=7 HEAD).apk || exit 1
...
curl -T \
	...
	"app/kpsconnect-beta-$(git rev-parse --short=7 HEAD).apk" "https://kpsconnect.msfjarvis.me/ci-builds"
