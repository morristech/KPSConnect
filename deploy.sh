...
export tg_message="\[KPSConnect] Build number $BUILD_NUMBER succeeded, changes [here](http://jenkins.msfjarvis.me/job/afh-browser-master/$BUILD_NUMBER/changes). Build a$
